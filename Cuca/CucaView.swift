...
//    @State private var photoLocation: (CGPoint = CGPoint(x: UIScreen.main.bounds.width * 0.10, y: UIScreen.main.bounds.height * 0.80))
    ...
    @State var cuca = "cuca1"
    @State private var saciLocation: CGPoint = CGPoint(x: UIScreen.main.bounds.width * 0.28 , y: UIScreen.main.bounds.height * 0.50)
...
//                }
        ...
        GeometryReader { geo in
            ...
            Image("garrafa")
                .resizable()
                .frame(width: 100, height: 100)
                .blur(radius: itemHasDroppedGarrafa ? 0 : 3)
                .scaledToFit()
